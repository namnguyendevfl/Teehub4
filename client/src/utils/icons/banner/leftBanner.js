...
export const leftBanner = {
    homeIcon: () => <svg xmlns="http://www.w3.org/2000/svg" 
                    id = "home"
    ...
    dotCircleIcon: () => <svg xmlns="http://www.w3.org/2000/svg" 
                        id = "focus"
    ...
    coffeeIcon: () =>  <svg xmlns="http://www.w3.org/2000/svg" 
                        id = "social"
                        width="30" height="38" 
                        className="ionicon" 
                        viewBox="0 0 512 512">
    ...
    journalIcon: () =>   <svg xmlns="http://www.w3.org/2000/svg" 
                        id = "journal"
                        width="25" height="22" 
                        fill={iconStroke}
    ...
    timerIcon: () =>  <svg xmlns="http://www.w3.org/2000/svg" 
                    id = "timer"
                    width="25" height="25" 
                    fill={iconStroke}
    ...
    forwardArrowIcon: () => <svg xmlns="http://www.w3.org/2000/svg" 
